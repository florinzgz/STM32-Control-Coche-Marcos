...
| BL | **GPIO16** | Backlight (HIGH = encendido) | — |
| | | **Subtotal:** | **7 pines** |
...
| 12 | GPIO16 | Display TFT | BL (Backlight) |
...
| 11 | GPIO16 | GPIO | **ASIGNADO** — Display TFT BL (Backlight) |
