...
| **Level-shifter** | TXS0108E (5 V → 3.3 V) — obligatorio entre encoder y STM32 |
...
| 1 | Level-shifter encoder | TXS0108E (5V↔3.3V) | €2 |
...
| 2 | Condensador desacoplo TXS0108E | 100nF cerámico (VA y VB) |
...
- `docs/ENCODER_WIRING_TXS0108E.md` — esquema completo de conexión del encoder
