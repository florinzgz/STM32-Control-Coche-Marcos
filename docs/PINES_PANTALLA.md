...
| **LED / BL**       | Retroiluminación (backlight)           | **GPIO 16**   | `TFT_BL`; HIGH = encendido, LOW = apagado |
...
| GPIO 16       | LED / BL           | Control de retroiluminación |
...
#define TFT_BL           16   // GPIO 16 — backlight
...
| GPIO 16 → GND (encendido)  | 3.3 V (HIGH)   | 0 V → backlight apagado |
...
|-------------------------|-----------------------------------------|----------|
| Pantalla completamente negra | Backlight apagado o sin alimentación | Verificar VCC = 3.3 V y GPIO 16 = HIGH |
