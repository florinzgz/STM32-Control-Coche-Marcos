...
| Relés RELAY_MAIN / RELAY_TRAC / RELAY_DIR | Transitorios al abrir/cerrar | Picos de 50–200 V sobre GND_chasis (sin snubber) | Acoplamiento por inductancia parásita del cableado |
