...
> ⚠ **CAN rev 1.4 (2026-04-23):** El relé de audio (módulo `relay_audio` en ESP32) es **independiente** del subsistema de relés de potencia del STM32 y **no se ve afectado** por la eliminación del relé MAIN. El bitmap de estado de relés en heartbeat 0x001 byte 5 ahora tiene 2 bits (TRAC/DIR) — este documento sigue siendo válido tal cual para `relay_audio`.
