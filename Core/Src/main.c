...
{
    /*
     * Placeholder – this function must be generated by STM32CubeMX for the
     * target clock configuration (170 MHz from HSI + PLL).  Without it the
     * MCU runs at the default HSI frequency (16 MHz) and all peripheral
     * timings (PWM, baud rates, delays) will be ~10× slower than intended.
     *
     * In STM32CubeMX:  RCC → HSI → PLL → SYSCLK = 170 MHz
     *                   APB1/APB2 prescalers as needed
     */
}
