...
{
    /* Safe the hardware: drive GPIO outputs LOW (relays off).
     * PC6/PC7/PC9 are now timer AF outputs (LPWM) — writing BSRR on
     * a non-GPIO pin is ignored by the peripheral, but only clear the
     * pins that are actually configured as GPIO outputs.               */
