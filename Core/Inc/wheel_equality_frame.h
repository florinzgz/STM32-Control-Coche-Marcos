/**
  ...
  *          frame (Bloque C6, PR #445 Hito 2 — wheel-equality / BTS7960
  *          health test).
  *
  ...
  * 4 wheels = 16 frames per results burst, emitted once when Phase 1
  * completes and again (overwriting) if Phase 2 also runs.
  *
  ...
  *
  * FIELD_ID 0 — SPEED:
  *   b1-b2 : pulses_per_sec_25   (u16 LE, saturating)
  *   b3-b4 : pulses_per_sec_50   (u16 LE, saturating)
  *   b5-b6 : normalized_speed_x1000 (u16 LE, saturating; pulses/s per
  *                                   (pwm_pct x battery_V), x1000 for 3
  *                                   decimals of resolution)
  *   b7    : deviation_pct       (u8, 0..100 saturating; |value-median| /
  *                                median x 100, magnitude only)
  *
  * FIELD_ID 1 — CURRENT / SLOPE:
  *   b1-b2 : current_ma_25       (u16 LE, saturating)
  *   b3-b4 : current_ma_50       (u16 LE, saturating; this is the value
  *                                shown in the HMI's single "corriente"
  *                                column)
  ...
  *                                normalized-speed asymmetry at the 50 %
  *                                step, x10 for 1 decimal)
 ...
 *         @p in or @p out is NULL, or field_id is out of range (0..3).
 */
