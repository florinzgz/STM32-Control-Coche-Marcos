...
// -------------------------------------------------------------------------
inline constexpr uint32_t HEARTBEAT_STM32       = 0x001;    // DLC 6, 100 ms (byte5=relay status, rev 1.4: bit0=TRAC, bit1=DIR, bit7=SEQ)
...
inline constexpr uint32_t STATUS_SAFETY         = 0x203;    // DLC 5, 100 ms  (ABS,TCS,error_code,state,rx_err)
