...
//   3.5–3.6 V on TX.  ESP32-S3 absolute max is 3.6 V → voltage divider
//   REQUIRED (1 kΩ + 4.7 kΩ to GND) between sensor TX and GPIO 18.
//   See docs/TOFSENSE_M_WIRING_GUIDE.md for wiring diagram.
//
