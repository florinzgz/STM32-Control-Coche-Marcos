...
//
// Also transmits CAN frame 0x209 (OBSTACLE_SAFETY) at 100 ms interval
// with the ESP32's computed obstacle safety state (informational).
//
// Payload 0x208 (DLC 5):
...
/// Update and transmit 0x208 and 0x209 frames if interval elapsed.
